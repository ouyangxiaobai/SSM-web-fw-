...
<body>
	<table width="100%" border="0" cellpadding="8" cellspacing="0" align=center>
		<tr style="background-image: url(images/top_back.gif);">
			<td width="22%" valign="middle" style="font-size: 30px; height: 60px">房屋租售系统</td>
		...
		<tr style="background-image: url(images/top_bg.gif); height: 16px">
			...
			<td width="60%" align="right" style="color: #000000;"><a href="<%=basePath%>admin/editpwd.jsp" target="main">修改密码</a>
				<a href="<%=basePath%>admin/exit.action" target="_parent">退出系统</a></td>
		</tr>
	</table>
</body>
</html>
