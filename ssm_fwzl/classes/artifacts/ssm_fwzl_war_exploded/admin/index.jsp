				...
				<tr>
					<td vAlign=top bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=0 width="100%" border=0>
							<tbody>
								<tr>
									<td width=460 background=images/login_top.jpg height=54 class="bt">欢迎使用房屋租售系统</td>
								</tr>
								<tr>
								...
								<tr>
									<td align=middle bgColor=#9CBFE5 height=25> 房屋租售系统 All Rights Reserved</td>
								</tr>
							</tbody>
						</table>
					</td>
